...
**step 1**<br> Download the package, unzip and burn the image on an sd card. 'Tip: use 'Raspberry Pi Imager' see [WIKI](https://github.com/patience4711/RPI-APS-inverters/wiki/0-PREPAIRING-THE-HARDWARE#software)).
If you are new user of this software please continue with stap 3.<br>
...
- added API to throttle inverters

**version RPI-ECU-v4_6** aug 22 2025
- added throttle tools
